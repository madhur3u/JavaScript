// node topLN.js --url="https://myanimelist.net/topmanga.php?type=lightnovels&limit=" --pages=1
...
console.log('Welcome !!!')
console.log('Here we will be scrapping myanimelist.com top Light Novels')
console.log('You wanted to scrap',args.pages,'no. of pages i.e.',(args.pages)*50,'LNs')
console.log('Starting Now ... \n ')
ScrapeData(args.url, args.pages);

// this function is getting all data which is in list page
...
async function ScrapeData(url, n) {
	...
	try{
		...
		let sheetName = "Top " + n*50 + " Light Novels"
...
// we have a list in which all link are present in order
